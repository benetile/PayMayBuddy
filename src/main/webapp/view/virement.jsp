        ...
        <body>
                    ...
                    <div class="container" id="homediv">
                         <div class ="jumbotron text-center">
                           <c:choose>
                            <c:when test="${mode=='VIREMENT'}" >
                            <c:if test="${ !empty compteV }" >
                               <fieldset>
                               ...
                               <table class="table table-striped-bordered">
                                 ...
                                 <thead>
                                   <tr>
                                   <th>Id Compte</th><th>${compteV.id_compte}</th></tr>
                                   <tr><th>Sold</th><th>${compteV.sold}</th></tr>
                                   <tr><th>Id Utilisateur</th><th>${compteV.user_id}</th>
